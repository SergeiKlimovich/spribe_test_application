...
public class CurrencyControllerTest {
    ...
    void testGetExchangeRate() throws Exception {
        ...
        when(currencyService.getExchangeRateByCode(code)).thenReturn(1.0);
        ...
        verify(currencyService, times(1)).getExchangeRateByCode(code);
        verifyNoMoreInteractions(currencyService);
    }
    ...
    void testAddCurrency() throws Exception {
        ...
        verify(currencyService, times(1)).saveCurrency(code);
        verifyNoMoreInteractions(currencyService);
    }
}
